...
Для проверки можно загрузить `input/sample_sales.csv` и написать инструкцию:

```text
Проанализируй выручку по регионам и каналам, найди аномалии и покажи, где скидка связана с количеством заказов.
```
